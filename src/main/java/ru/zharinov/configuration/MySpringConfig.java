package ru.zharinov.configuration;
...
@Configuration
@ComponentScan("ru.zharinov")
@EnableWebMvc
@EnableTransactionManagement
@EnableJpaRepositories("ru.zharinov.repositories")
...
public class MySpringConfig implements WebMvcConfigurer {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        factory.setPackagesToScan("ru.zharinov.entities");
